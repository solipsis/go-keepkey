...
func (*NanoGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*NanoAddress) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func (*NanoSignTx) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{2} }
...
func (*NanoSignTx_ParentBlock) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{2, 0} }
...
func (*NanoSignedTx) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{3} }
...
func init() { proto.RegisterFile("messages-nano.proto", fileDescriptor4) }
