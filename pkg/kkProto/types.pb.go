...
func (FailureType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{0}
}
...
func (OutputScriptType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{1}
}
...
func (InputScriptType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{2}
}
...
func (RequestType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{3}
}
...
func (OutputAddressType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{4}
}
...
func (ButtonRequestType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{5}
}
...
func (PinMatrixRequestType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{6}
}
...
func (*TransactionType) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{7}
}
...
func (*RawTransactionType) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{8}
}
...
func (*TxRequestDetailsType) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{9}
}
...
func (*TxRequestSerializedType) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{10}
}
...
func (*IdentityType) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{11}
}
...
func (*PolicyType) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{12}
}
...
func (*ExchangeType) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_00ff35760b84bad6, []int{13}
}
...
func init() { proto.RegisterFile("types.proto", fileDescriptor_types_00ff35760b84bad6) }

var fileDescriptor_types_00ff35760b84bad6 = []byte{
