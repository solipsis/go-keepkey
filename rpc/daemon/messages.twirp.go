...
func (c *daemonProtobufClient) Ping(ctx context.Context, in *PingRequest) (*PingResponse, error) {
...
func (c *daemonJSONClient) Ping(ctx context.Context, in *PingRequest) (*PingResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "solipsis.gkk.daemon")
	ctx = ctxsetters.WithServiceName(ctx, "Daemon")
	ctx = ctxsetters.WithMethodName(ctx, "Ping")
	out := new(PingResponse)
